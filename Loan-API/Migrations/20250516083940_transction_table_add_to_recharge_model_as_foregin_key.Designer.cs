...
namespace Loan_API.Migrations
{
    ...
    [Migration("20250516083940_transction_table_add_to_recharge_model_as_foregin_key")]
    partial class transction_table_add_to_recharge_model_as_foregin_key
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Loan_API.Entities.LoanInstalment", b =>
                {
                    ...
                    b.Property<decimal?>("LateChargePaid")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Loan_API.Entities.Transaction", b =>
                {
                    ...
                    b.HasOne("Loan_API.Entities.RechargeAccount", "PaymentMethod")
                        .WithMany()
